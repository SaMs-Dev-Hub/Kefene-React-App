      ...
      <div className={style.divContainer}>
        ...
        <span>
          <input
            ...
            value={text}
          />
          <button className={style.clearBtn} value={text} onClick={clearText}>
            Clear
          </button>
        </span>
      </div>
        ...
        {filter.map((userList, index) => {
          return (
            <tr className={style.active} key={userList.profilePic}>
              ...
              <td className={style.column21}>
                <img src={userList.profilePic} alt="Profile pic" />
              </td>
              ...
              <td
                className={style.column61}
              >{`${userList.currentCity},${userList.currentCountry}`}</td>
            </tr>
          );
        })}
      </div>
